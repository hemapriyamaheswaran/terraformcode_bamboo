...
Start-Process -FilePath C:\Salt-Minion-2019.2.0-Py2-AMD64-Setup.exe -ArgumentList "/S /master=10.0.0.27 /minion-name=saltstackwindowsbamboodotnet.zippyops.com"
</powershell>
