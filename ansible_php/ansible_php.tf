resource "openstack_compute_instance_v2" "Ansible_php_centos" {
  name            = "Ansible_php_centos"
...
resource "openstack_compute_instance_v2" "Ansible_php_ubuntu" {
  name            = "Ansible_php_ubuntu"
...
resource "openstack_compute_instance_v2" "Ansible_php_windows12" {
  name            = "Ansible_php_windows12"
