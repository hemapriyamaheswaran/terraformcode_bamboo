resource "openstack_compute_instance_v2" "chef_nodejs_centos" {
  name            = "chef_nodejs_centos"
...
resource "openstack_compute_instance_v2" "chef_nodejs_ubuntu" {
  name            = "chef_nodejs_ubuntu"
...
resource "openstack_compute_instance_v2" "chef_nodejs_windows" {
  name            = "chef_nodejs_windows"
