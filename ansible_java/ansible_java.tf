resource "openstack_compute_instance_v2" "Bamboo_Ansible_java_centos" {
  name            = "Bamboo_Ansible_java_centos"
...
resource "openstack_compute_instance_v2" "Bamboo_Ansible_java_ubuntu" {
  name            = "Bamboo_Ansible_java_ubuntu"
...
resource "openstack_compute_instance_v2" "Bamboo_Ansible_java_windows12" {
  name            = "Bamboo_Ansible_java_windows12"
...
resource "openstack_compute_floatingip_associate_v2" "fip_1" {
  ...
  instance_id = "${openstack_compute_instance_v2.Bamboo_Ansible_java_centos.id}"
        }

resource "openstack_compute_floatingip_associate_v2" "fip_2" {
  floating_ip = "${openstack_networking_floatingip_v2.fip_2.address}"
  instance_id = "${openstack_compute_instance_v2.Bamboo_Ansible_java_ubuntu.id}"
        }

resource "openstack_compute_floatingip_associate_v2" "fip_3" {
  floating_ip = "${openstack_networking_floatingip_v2.fip_3.address}"
  instance_id = "${openstack_compute_instance_v2.Bamboo_Ansible_java_windows12.id}"
        }
