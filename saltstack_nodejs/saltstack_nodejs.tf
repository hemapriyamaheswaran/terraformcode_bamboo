resource "openstack_compute_instance_v2" "saltstack_nodejs_centos" {
  name            = "saltstack_nodejs_centos"
...
resource "openstack_compute_instance_v2" "saltstack_nodejs_ubuntu" {
  name            = "saltstack_nodejs_ubuntu"
...
resource "openstack_compute_instance_v2" "saltstack_nodejs_windows12" {
  name            = "saltstack_nodejs_windows12"
